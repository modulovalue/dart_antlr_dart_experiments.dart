...
abstract class DartListener extends ParseTreeListener {
  ...
  /// Enter a parse tree produced by [DartParser.libraryDeclaration].
  /// [ctx] the parse tree
  void enterLibraryDeclaration(LibraryDeclarationContext ctx);
  /// Exit a parse tree produced by [DartParser.libraryDeclaration].
  /// [ctx] the parse tree
  void exitLibraryDeclaration(LibraryDeclarationContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.primaryConstructor].
  /// [ctx] the parse tree
  void enterPrimaryConstructor(PrimaryConstructorContext ctx);
  /// Exit a parse tree produced by [DartParser.primaryConstructor].
  /// [ctx] the parse tree
  void exitPrimaryConstructor(PrimaryConstructorContext ctx);

  /// Enter a parse tree produced by [DartParser.classNameMaybePrimary].
  /// [ctx] the parse tree
  void enterClassNameMaybePrimary(ClassNameMaybePrimaryContext ctx);
  /// Exit a parse tree produced by [DartParser.classNameMaybePrimary].
  /// [ctx] the parse tree
  void exitClassNameMaybePrimary(ClassNameMaybePrimaryContext ctx);

  /// Enter a parse tree produced by [DartParser.memberedDeclarationBody].
  /// [ctx] the parse tree
  void enterMemberedDeclarationBody(MemberedDeclarationBodyContext ctx);
  /// Exit a parse tree produced by [DartParser.memberedDeclarationBody].
  /// [ctx] the parse tree
  void exitMemberedDeclarationBody(MemberedDeclarationBodyContext ctx);

  /// Enter a parse tree produced by [DartParser.memberDeclarations].
  /// [ctx] the parse tree
  void enterMemberDeclarations(MemberDeclarationsContext ctx);
  /// Exit a parse tree produced by [DartParser.memberDeclarations].
  /// [ctx] the parse tree
  void exitMemberDeclarations(MemberDeclarationsContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.memberDeclaration].
  /// [ctx] the parse tree
  void enterMemberDeclaration(MemberDeclarationContext ctx);
  /// Exit a parse tree produced by [DartParser.memberDeclaration].
  /// [ctx] the parse tree
  ...
  /// Enter a parse tree produced by [DartParser.extensionBody].
  /// [ctx] the parse tree
  void enterExtensionBody(ExtensionBodyContext ctx);
  /// Exit a parse tree produced by [DartParser.extensionBody].
  /// [ctx] the parse tree
  void exitExtensionBody(ExtensionBodyContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.declaringParameterList].
  /// [ctx] the parse tree
  void enterDeclaringParameterList(DeclaringParameterListContext ctx);
  /// Exit a parse tree produced by [DartParser.declaringParameterList].
  /// [ctx] the parse tree
  void exitDeclaringParameterList(DeclaringParameterListContext ctx);

  /// Enter a parse tree produced by [DartParser.declaringFormalParameters].
  /// [ctx] the parse tree
  void enterDeclaringFormalParameters(DeclaringFormalParametersContext ctx);
  /// Exit a parse tree produced by [DartParser.declaringFormalParameters].
  /// [ctx] the parse tree
  void exitDeclaringFormalParameters(DeclaringFormalParametersContext ctx);

  /// Enter a parse tree produced by [DartParser.declaringFormalParameter].
  /// [ctx] the parse tree
  void enterDeclaringFormalParameter(DeclaringFormalParameterContext ctx);
  /// Exit a parse tree produced by [DartParser.declaringFormalParameter].
  /// [ctx] the parse tree
  void exitDeclaringFormalParameter(DeclaringFormalParameterContext ctx);

  /// Enter a parse tree produced by [DartParser.declaringFormalParameterNoMetadata].
  /// [ctx] the parse tree
  void enterDeclaringFormalParameterNoMetadata(DeclaringFormalParameterNoMetadataContext ctx);
  /// Exit a parse tree produced by [DartParser.declaringFormalParameterNoMetadata].
  /// [ctx] the parse tree
  void exitDeclaringFormalParameterNoMetadata(DeclaringFormalParameterNoMetadataContext ctx);

  /// Enter a parse tree produced by [DartParser.declaringFunctionFormalParameter].
  /// [ctx] the parse tree
  void enterDeclaringFunctionFormalParameter(DeclaringFunctionFormalParameterContext ctx);
  /// Exit a parse tree produced by [DartParser.declaringFunctionFormalParameter].
  /// [ctx] the parse tree
  void exitDeclaringFunctionFormalParameter(DeclaringFunctionFormalParameterContext ctx);

  /// Enter a parse tree produced by [DartParser.declaringSimpleFormalParameter].
  /// [ctx] the parse tree
  void enterDeclaringSimpleFormalParameter(DeclaringSimpleFormalParameterContext ctx);
  /// Exit a parse tree produced by [DartParser.declaringSimpleFormalParameter].
  /// [ctx] the parse tree
  void exitDeclaringSimpleFormalParameter(DeclaringSimpleFormalParameterContext ctx);

  /// Enter a parse tree produced by [DartParser.optionalOrNamedDeclaringFormalParameters].
  /// [ctx] the parse tree
  void enterOptionalOrNamedDeclaringFormalParameters(OptionalOrNamedDeclaringFormalParametersContext ctx);
  /// Exit a parse tree produced by [DartParser.optionalOrNamedDeclaringFormalParameters].
  /// [ctx] the parse tree
  void exitOptionalOrNamedDeclaringFormalParameters(OptionalOrNamedDeclaringFormalParametersContext ctx);

  /// Enter a parse tree produced by [DartParser.optionalPositionalDeclaringFormalParameters].
  /// [ctx] the parse tree
  void enterOptionalPositionalDeclaringFormalParameters(OptionalPositionalDeclaringFormalParametersContext ctx);
  /// Exit a parse tree produced by [DartParser.optionalPositionalDeclaringFormalParameters].
  /// [ctx] the parse tree
  void exitOptionalPositionalDeclaringFormalParameters(OptionalPositionalDeclaringFormalParametersContext ctx);

  /// Enter a parse tree produced by [DartParser.defaultDeclaringFormalParameter].
  /// [ctx] the parse tree
  void enterDefaultDeclaringFormalParameter(DefaultDeclaringFormalParameterContext ctx);
  /// Exit a parse tree produced by [DartParser.defaultDeclaringFormalParameter].
  /// [ctx] the parse tree
  void exitDefaultDeclaringFormalParameter(DefaultDeclaringFormalParameterContext ctx);

  /// Enter a parse tree produced by [DartParser.namedDeclaringFormalParameters].
  /// [ctx] the parse tree
  void enterNamedDeclaringFormalParameters(NamedDeclaringFormalParametersContext ctx);
  /// Exit a parse tree produced by [DartParser.namedDeclaringFormalParameters].
  /// [ctx] the parse tree
  void exitNamedDeclaringFormalParameters(NamedDeclaringFormalParametersContext ctx);

  /// Enter a parse tree produced by [DartParser.defaultDeclaringNamedParameter].
  /// [ctx] the parse tree
  void enterDefaultDeclaringNamedParameter(DefaultDeclaringNamedParameterContext ctx);
  /// Exit a parse tree produced by [DartParser.defaultDeclaringNamedParameter].
  /// [ctx] the parse tree
  void exitDefaultDeclaringNamedParameter(DefaultDeclaringNamedParameterContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.constructorTwoPartName].
  /// [ctx] the parse tree
  void enterConstructorTwoPartName(ConstructorTwoPartNameContext ctx);
  /// Exit a parse tree produced by [DartParser.constructorTwoPartName].
  /// [ctx] the parse tree
  void exitConstructorTwoPartName(ConstructorTwoPartNameContext ctx);

  /// Enter a parse tree produced by [DartParser.constructorHead].
  /// [ctx] the parse tree
  void enterConstructorHead(ConstructorHeadContext ctx);
  /// Exit a parse tree produced by [DartParser.constructorHead].
  /// [ctx] the parse tree
  void exitConstructorHead(ConstructorHeadContext ctx);

  /// Enter a parse tree produced by [DartParser.factoryConstructorHead].
  /// [ctx] the parse tree
  void enterFactoryConstructorHead(FactoryConstructorHeadContext ctx);
  /// Exit a parse tree produced by [DartParser.factoryConstructorHead].
  /// [ctx] the parse tree
  void exitFactoryConstructorHead(FactoryConstructorHeadContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.primaryConstructorBodySignature].
  /// [ctx] the parse tree
  void enterPrimaryConstructorBodySignature(PrimaryConstructorBodySignatureContext ctx);
  /// Exit a parse tree produced by [DartParser.primaryConstructorBodySignature].
  /// [ctx] the parse tree
  void exitPrimaryConstructorBodySignature(PrimaryConstructorBodySignatureContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.enumBody].
  /// [ctx] the parse tree
  void enterEnumBody(EnumBodyContext ctx);
  /// Exit a parse tree produced by [DartParser.enumBody].
  /// [ctx] the parse tree
  ...
  /// Enter a parse tree produced by [DartParser.nullAwareExpressionElement].
  /// [ctx] the parse tree
  void enterNullAwareExpressionElement(NullAwareExpressionElementContext ctx);
  /// Exit a parse tree produced by [DartParser.nullAwareExpressionElement].
  /// [ctx] the parse tree
  void exitNullAwareExpressionElement(NullAwareExpressionElementContext ctx);

  /// Enter a parse tree produced by [DartParser.nullAwareMapElement].
  /// [ctx] the parse tree
  void enterNullAwareMapElement(NullAwareMapElementContext ctx);
  /// Exit a parse tree produced by [DartParser.nullAwareMapElement].
  /// [ctx] the parse tree
  void exitNullAwareMapElement(NullAwareMapElementContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.staticMemberShorthand].
  /// [ctx] the parse tree
  void enterStaticMemberShorthand(StaticMemberShorthandContext ctx);
  /// Exit a parse tree produced by [DartParser.staticMemberShorthand].
  /// [ctx] the parse tree
  void exitStaticMemberShorthand(StaticMemberShorthandContext ctx);

  /// Enter a parse tree produced by [DartParser.staticMemberShorthandHead].
  /// [ctx] the parse tree
  void enterStaticMemberShorthandHead(StaticMemberShorthandHeadContext ctx);
  /// Exit a parse tree produced by [DartParser.staticMemberShorthandHead].
  /// [ctx] the parse tree
  void exitStaticMemberShorthandHead(StaticMemberShorthandHeadContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.outerPatternDeclarationPrefix].
  /// [ctx] the parse tree
  void enterOuterPatternDeclarationPrefix(OuterPatternDeclarationPrefixContext ctx);
  /// Exit a parse tree produced by [DartParser.outerPatternDeclarationPrefix].
  /// [ctx] the parse tree
  void exitOuterPatternDeclarationPrefix(OuterPatternDeclarationPrefixContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.forInLoopPrefix].
  /// [ctx] the parse tree
  void enterForInLoopPrefix(ForInLoopPrefixContext ctx);
  /// Exit a parse tree produced by [DartParser.forInLoopPrefix].
  /// [ctx] the parse tree
  void exitForInLoopPrefix(ForInLoopPrefixContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.libraryNameBody].
  /// [ctx] the parse tree
  void enterLibraryNameBody(LibraryNameBodyContext ctx);
  /// Exit a parse tree produced by [DartParser.libraryNameBody].
  /// [ctx] the parse tree
  void exitLibraryNameBody(LibraryNameBodyContext ctx);
  ...
  /// Enter a parse tree produced by [DartParser.libraryAugmentImport].
  /// [ctx] the parse tree
  void enterLibraryAugmentImport(LibraryAugmentImportContext ctx);
  /// Exit a parse tree produced by [DartParser.libraryAugmentImport].
  /// [ctx] the parse tree
  void exitLibraryAugmentImport(LibraryAugmentImportContext ctx);

...
// Add support for optional trailing commas in a present expressionList
// of a forLoopPart to match implemented behavior.
//
...
// TODO • submit these changes to get feedback?
relationalExpression
    :    typeExpression (relationalOperator typeExpression)?
    |    SUPER relationalOperator typeExpression
    ;
